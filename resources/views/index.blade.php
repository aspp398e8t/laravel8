                    ...
                    <div class="card-body">
                        <form action="{{route('contact')}}"method="POST">
                            ...
                            <div class="my-4">
                                ...
                                @enderror
                                {{-- @error('name') is aria-invalid @enderror --}}
                                <label for="phone" class="form-label">電話</label>
                                <input type="text" class="form-control mb-3" @error('phone') is aria-invalid @enderror id="phone" name="phone" value="{{old('phone')}}" aria-describedby="basic-addon3">
                                ...
                                <input type="text" class="form-control mb-3" @error('email') is aria-invalid @enderror id="email" name="email" value="{{old('email')}}" aria-describedby="basic-addon3">
                                ...
                                <textarea type="text" rows="4" class="form-control message_textarea" @error('content') is aria-invalid @enderror id="content" name="content"
